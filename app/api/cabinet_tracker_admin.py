...
Роль в коде по-прежнему называется «админ» (ранг 4) — это внутренний ключ, по
нему ходят ROLE_CABINET_MAP и тесты. Человек везде видит «Главный
преподаватель»: подписи переименованы, строку в таблице roles правит миграция
c8e1a4f37b02.
