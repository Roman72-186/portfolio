...
# элемент такого вида.
#
# Следствие, вынесенное владельцу в ВОПРОСЫ-ПО-ЛЕНТЕ.md: поставить в день
# новый пробник с билетом и таймером или новую самостоятельную работу с
# приёмом файлов теперь нельзя — этих механик у блоков пока нет.
