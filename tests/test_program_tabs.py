"""Раздел «Актуальное образовательное пространство»: одна шапка вкладок на четырёх экранах.

Дайджест, Цели и Загрузка видео перестали быть пунктами меню персонала и стали
...
def test_program_tabs_render_on_every_section_page(
    ...
    assert 'aria-label="Актуальное образовательное пространство"' in response.text
